...
<html lang="en" class="wow-animation">
  <head>
    <!-- Site Title-->
    <title>Leadership & Executive Search</title>
    ...
    <div class="page text-center">
      ...
      <header class="page-header slider-menu-position">
              <!-- RD Navbar Transparent-->
               <?php echo $header; ?>
        <!-- Modern Breadcrumbs-->
        <div class="section-height-800 breadcrumb-modern bg-exec context-dark text-center breadcrumbs-center">
          <div class="shell section-bottom-30">
            <div class="veil reveal-md-block">
              <h1 class="text-bold">Leadership & Executive Search</h1>
            </div>
            <ul class="list-inline list-inline-with-arrows p">
              <li><a href="index.php" class="text-white">Home</a></li>
              <li>Markets</li>
              <li>Leadership & Executive Search
              </li>
            </ul>
          </div>
        </div>
...
The Executive & Leadership Division became a natural evolution of our services from existing clients seeking our guidance and services in search of leadership and executives for their organizations. FSR has an in-depth appreciation and understanding of the challenges of recruiting, hiring, and building strongly aligned teams. As businesses and industries evolve, leadership is key in navigating the marketplace and driving innovation. 
<br><br>
We provide talent acquisition services for retained and contingent searches. Our goal is to identify exceptional candidates that can bring value to your organization. FSR utilizes an assessment process that supports the hiring process for career minded long-term placements. FSR takes the time to understand your mission, vision, and culture along with the overall working environment and expectations to ensure the best fit when identifying the top performing candidates.
<br><br>
...
<a target="blank" href="https://fsrpeople.isolvedhire.com/jobs/" class="btn btn-circle btn-primary">Job Openings</a>
            ...
            <div class="cell-xs-10 cell-sm-8 cell-md-6 cell-lg-preffix-1">
              <img src="images/FSR_LES.jpg" style=" max-width: 100%;">
            </div>
          </div>
        </div>
      </section>
