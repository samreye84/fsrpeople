    ...
    <!-- Page-->
      ...
      <header class="page-header slider-menu-position">
              <!-- RD Navbar Transparent-->
               <?php echo $header; ?>
        <!-- Modern Breadcrumbs-->
        <div class="section-height-800 breadcrumb-modern bg-leadership context-dark text-center breadcrumbs-center">
          <div class="shell section-bottom-30">
            <div class="veil reveal-md-block">
              <h1 class="text-bold">Leadership</h1>
            </div>
...
<div class="shell-fluid">
          ...
          <h2 class="header-preffix text-bold" style="margin-bottom: 0px;">Leadership</h2>
            <div class="cell-xs-10 cell-sm-8 cell-lg-8 offset-top-15">
              
            </div>
            
            <div class="cell-xs-10 cell-sm-8 cell-lg-8 offset-top-15">
              <img src="images/Tracy FSR.jpg" class="img-responsive" style="
    float: left;
    margin-top: 14px;
    padding-bottom: 17px;
    padding-right: 10px;
...
For 25 years Tracy cared for patients dealing with devastating injuries as a Registered Nurse in trauma and ICU units in a variety of settings, including numerous prestigious hospital systems in New York, Baltimore, and Washington, D.C. 
</p><p>
...
Tracy grew up on military bases and experienced first hand the sacrifices and dedication of service members and their families. She knows the sadness of parent’s deployment and the jubilation of a ship’s return. Tracy’s dedication to service has lived on through FSR.
Tracy firmly believes no veteran should have to fight for a job. Inspired by the White House hiring initiative, she created FSR’s Working Warrior Program ℠ to help veterans navigate the complex job market, incentives companies with veterans hiring initiatives, and help companies navigate the vast and diverse veteran talent tool and parleying their military experience to the private sector. 
</p><p>
