<!DOCTYPE html>
<?php $page = 'search'; require_once('includes/common.php'); ?>
  ...
  <body>
    ...
    <div class="page text-center">
      ...
      <header class="page-header slider-menu-position">
              ...
              <?php echo $header; ?>
        <!-- Modern Breadcrumbs-->
        <div class="section-height-800 bg-image-home-1 breadcrumb-modern context-dark text-center breadcrumbs-center">
              ...
              <form action="search-results.html" method="GET" class="form-search rd-search">
                <div class="form-group">
                  <div class="input-group input-group-sm">
                    <label for="search-results" class="form-label form-label-lg form-search-label rd-input-label">Search...</label>
                    <input id="search-results" type="text" name="s" autocomplete="off" class="form-search-input form-control"><span class="input-group-btn">
